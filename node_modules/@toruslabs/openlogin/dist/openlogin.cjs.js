...
class OpenLogin_OpenLogin {
  constructor(options) {
    ...
    if (!options._iframeUrl) {
      ...
      } else if (options.network === constants["d" /* OPENLOGIN_NETWORK */].CYAN) {
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _IStore__WEBPACK_IMPORTED_MODULE_1__) if(["default","loglevel","OpenLoginStore","Provider","modalDOMElementID","storeKey","UX_MODE","OPENLOGIN_METHOD","ALLOWED_INTERACTIONS","OPENLOGIN_NETWORK","LOGIN_PROVIDER"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _IStore__WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _loglevel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
